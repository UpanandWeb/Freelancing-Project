...
<body>
								...
								<li><a href="about_us.php" >About</a></li>
								 <li><a href="#" class="dropdown-toggle" data-toggle="dropdown" 
									...
									<ul class="dropdown-menu"> 
										...
										<li class="active"><a href="branding.php">Aerial Branding</a></li>
	...
	<div class="banner-bottom" id="about">
		<div class="container">
			<h3 class="heading-agileinfo font-family" data-aos="zoom-in">Aerial Brainding</h3>
			<div class="w3ls_banner_bottom_grids">
				<div class="col-md-12 agileits_services_grid" data-aos="fade-right">
					<div class="col-md-4">
                <img src="aerosports images/branding.jpg" alt="Arial Branding" class="custome_image" />
                </div><!--end col-md-4-->
				
					<div class="col-md-8">
                	<p class="text-color">
					Aerial branding is one of the most innovate method of advertising which grabs the attention of the viewers. Aerial branding which is used in a big way in the western countries like the USA,UK, France and Germany and  has started to make its presence felt in India now because of the high impact it makes on its audience. We have many years of experience in Aerial branding and will take your brand to a vast audience in a stunning graphic message.   
					</p>
                  </div><!--end col-md-8-->
				</div>
