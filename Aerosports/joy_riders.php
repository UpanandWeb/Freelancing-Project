...
<body>
								...
								<li><a href="about_us.php" >About</a></li>
								 <li><a href="#" class="dropdown-toggle" data-toggle="dropdown" 
									...
									<ul class="dropdown-menu"> 
										...
										<li class="active"><a href="joy_riders.php" >Joy Rides</a></li>
									</ul>
								</li>   
	...
	<div class="banner-bottom" id="about">
		<div class="container">
			<h3 class="heading-agileinfo font-family" data-aos="zoom-in">Joy Rides </h3>
			<div class="w3ls_banner_bottom_grids">
				<div class="col-md-12 agileits_services_grid" data-aos="fade-right">
					<div class="col-md-4">
                <img src="aerosports images/Joy_rides_2.jpg" alt="Joy Rides" class="custome_image" />
                </div><!--end col-md-4-->
				
					<div class="col-md-8">
                	<p class="text-color">
					If  you ever wanted to experience the sensation of flying like a bird in the sky you can try Para Gliding . It offers a joy ride like no another as you sit comfortably in a seat while a qualified pilot guides the Para Motor over the landscape over nature high up in the sky. 
You can bring your camera along to take some breath taking pics which will amaze your friend. You can post them on social media which will make you a star in your circle. 
A word of caution. While there is no limit of age of the necessity of any previous experience People with heart ailment are advised not to try it. So what are you waiting for? Hop on to a Para Motor and have a joy ride of your life.! High level of excitement is waiting you!
