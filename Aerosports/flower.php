...
<body>
								...
								<li><a href="about_us.php" >About</a></li>
								 <li><a href="#" class="dropdown-toggle" data-toggle="dropdown" 
									...
									<ul class="dropdown-menu"> 
										...
										<li class="active"><a href="flower.php">Flower Dropping</a></li>
	...
	<div class="banner-bottom" id="about">
		<div class="container">
			<h3 class="heading-agileinfo" data-aos="zoom-in">Flower Dropping </h3>
			<div class="w3ls_banner_bottom_grids">
				<div class="col-md-12 agileits_services_grid" data-aos="fade-right">
					 <div class="col-md-4">
                <img src="aerosports gallery/23.jpg" alt="Flower dropping with paragliding" class="custome_image" />
                </div><!--end col-md-4-->
				
					<div class="col-md-8">
                	<p class="text-color">
					flower dropping by Para motor has become the preferred choice due to its low cost . It scores over flower dropping by a helicopter because it has low flying ability and there is not much red tape in hiring it.  Flower dropping is used during Inaugurations, Religious functions or occasion like wedding or festivals. Advertisers also make use of it occasionally. 
We have many years of experience in flower dropping and have done so in many parts of the country. People have preferred Para motor as a better option than using a helicopter.
