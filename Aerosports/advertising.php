...
<body>
								...
								<li><a href="about_us.php" >About</a></li>
								 <li><a href="#" class="dropdown-toggle" data-toggle="dropdown" 
									...
									<ul class="dropdown-menu"> 
										...
										<li class="active"><a href="advertising.php" >Aerial Advertising</a></li>
	...
	<div class="banner-bottom" id="about">
		<div class="container">
			<h3 class="heading-agileinfo font-family" data-aos="zoom-in">Aerial Advertising </h3>
			<div class="w3ls_banner_bottom_grids">
				<div class="col-md-12 agileits_services_grid" data-aos="fade-right">
					<div class="col-md-4">
                <img src="aerosports images/05.jpg" alt="Advertising" class="custome_image" />
                </div><!--end col-md-4-->
				
					<div class="col-md-8">
                	<p class="text-color">
					Aerial advertising is used to drop pamphlets covering a large amount of area. Due to which a massive audience is reached. This mode of advertising contains a short message about the product or the services of the company. The message also gives the link of the website of the company where more information can be procured about the product or the services. Usually the pamphlets are air dropped in area where large number of people have gathered like a meeting or a beach. 
Banners which are made of cloth or flexis which are towed by the Para Motor are also very effective means of aerial advertising
