...
$to_email = 'aerosportstelangana@gmail.com';

$name =$_POST[$name];// 'Testing PHP Mail';
$email=$_POST[$email];
$phone_number=$_POST[$phone_number];
$message = $_POST[$message]; // 'This mail is sent using the PHP mail ';
...
if ($secure_check == false) {
    ...
    mail($to_email, $phone_number, $message, $headers);
...
<body>
								...
								<li><a href="about_us.php" >About</a></li>
								 <li><a href="#" class="dropdown-toggle" data-toggle="dropdown" 
									...
									<ul class="dropdown-menu"> 
										...
										<li class="active"><a href="paragliding.php">Paragliding</a></li>
	...
	<div class="banner-bottom" id="about">
		<div class="container">
			<h3 class="heading-agileinfo font-family" data-aos="zoom-in">Paragliding</h3>
			<div class="w3ls_banner_bottom_grids">
				<div class="col-md-12 agileits_services_grid" data-aos="fade-right">
                <div class="col-md-4">
                <img src="aerosports gallery/07.jpg" alt="paragliding" class="custome_image" />
                </div><!--end col-md-4-->
				
					<div class="col-md-8">
                	<p class="text-color">
					For many years paragliding was not such a popular sports in India but recently there has been a tremendous increase in the interest shown by the youth. And they are taking to paragliding in a big way which has made many sites mushroom all over India.
Paragliding is without any rigid framework  unlike hand glider. The parachute canopy is used like a wing  and is opened at the front  which make them inflated through the air.The pilot is seated on a harness which controls the cord which are attached to the wing.The take off and the landing usually take place on a hilly or high area. In the coming days the sports is set to grow further.
	...
	<div class="pricing" id="pricing">
		<div class="container">
			<h3 class="heading-agileinfo font-family" data-aos="zoom-in">Services</h3>
			<div class="w3ls_banner_bottom_grids text-color">
				
                <!--<div class="col-md-4 agileits_services_grid" data-aos="fade-right">
					<div class="w3_agile_services_grid1">
						<img src="aerosports images/tandem-paragliding-experience.jpg" alt=" " class="img-responsive">
						<div class="w3_blur"></div>
					</div>
					<div class="pr-ta text-color">
						<h3>Paragliding</h3>
						<p class="text-color-white">For many years paragliding was not such a popular sports in India but recently </p>						 
						<div class="tabl-erat">
							<div class="col-md-7 tag">
								<a href="paragliding.php">Read More...</a>
							</div>
							<div class="clearfix"></div>
						</div>
					</div>
				...
				<div class="col-md-4 agileits_services_grid" data-aos="fade-right">
					<div class="w3_agile_services_grid1">
						<img src="aerosports images/Paramotor_2.jpg" alt=" " class="img-responsive">
						<div class="w3_blur"></div>
					</div>
					<div class="pr-ta text-color">
						<h3>Paramotors</h3>
						<p class="text-color-white">
							One of the most unique way of gliding or flying is by using a paragliding wing  </p>						 
						<div class="tabl-erat">
							<div class="col-md-7 tag">
								<a href="paramotors.php">Read More...</a>
							</div>
							<div class="clearfix"></div>
						</div>
					</div>
				...
				<div class="col-md-4 agileits_services_grid" data-aos="fade-right">
					<div class="w3_agile_services_grid1">
						<img src="aerosports images/flower_dropper_2.jpg" alt=" " class="img-responsive">
						<div class="w3_blur"></div>
					</div>
					<div class="pr-ta text-color">
						<h3>Flower Dropping</h3>
						<p class="text-color-white">
							flower dropping by Para motor has become the preferred choice due to its </p>						 
						<div class="tabl-erat">
							<div class="col-md-7 tag">
								<a href="flower.php">Read More...</a>
							</div>
							<div class="clearfix"></div>
						</div>
					</div>
				 ...
				 <div class="col-md-4 agileits_services_grid" data-aos="fade-right">
					<div class="w3_agile_services_grid1">
						<img src="aerosports images/advertising_2.jpg" alt=" " class="img-responsive">
						<div class="w3_blur"></div>
					</div>
					<div class="pr-ta text-color">
						<h3>Aerial advertising</h3>
						<p class="text-color-white">
							Aerial advertising is used to drop pamphlets covering a large amount of</p>						 
						<div class="tabl-erat">
							<div class="col-md-7 tag">
								<a href="advertising.php">Read More...</a>
							</div>
							<div class="clearfix"></div>
						</div>
					</div>
...
<div class="clearfix"></div>
		<div class="w3ls_banner_bottom_grids">
				...
				<div class="col-md-4 agileits_services_grid" data-aos="fade-right">
					<div class="w3_agile_services_grid1">
						<img src="aerosports images/arial_branding_2.jpg" alt=" " class="img-responsive">
						<div class="w3_blur"></div>
					</div>
					<div class="pr-ta text-color">
						<h3>Aerial Branding</h3>
						<p class="text-color-white">
							Aerial branding is one of the most innovate method of advertising which grabs  </p>						 
						<div class="tabl-erat">
							<div class="col-md-7 tag">
								<a href="branding.php">Read More...</a>
							</div>
							<div class="clearfix"></div>
						</div>
					</div>
				...
				<div class="col-md-4 agileits_services_grid" data-aos="fade-right">
					<div class="w3_agile_services_grid1">
						<img src="aerosports images/joy_riders_2.jpg" alt=" " class="img-responsive">
						<div class="w3_blur"></div>
					</div>
					<div class="pr-ta text-color">
						<h3>Joy Rides</h3>
						<p class="text-color-white">
							If  you ever wanted to experience the sensation of flying like a bird in the sky you can try Para Gliding .    </p>						 
						<div class="tabl-erat">
							<div class="col-md-7 tag">
								<a href="joy_riders.php" >Read More...</a>
							</div>
							<div class="clearfix"></div>
						</div>
					</div>
...
<!-- /Portfolio section -->
	...
	<div class="clients-main jarallax" id="client">
		<div class="container">
			<!-- Owl-Carousel -->
			<h3 class="heading-agileinfo font-family" data-aos="zoom-in">TESTIMONIALS<span class="thr">Events Is A Professionally Managed Event </span></h3>
	...
	<div class="register-sec-w3l jarallax" id="book">
		<div class="container">
		<h3 class="heading-agileinfo font-family" data-aos="zoom-in">Book An Event<span class="thr">Events Is A Professionally Managed Event</span></h3>
	...
	<div class="container">
		...
		<div class="col-md-4 w3layouts_footer_grid" data-aos="fade-right">
					...
					<ul class="social_agileinfo">
						<li><a href="https://www.facebook.com/be" class="w3_facebook" target="_blank"><i class="fa fa-facebook"></i></a></li>
			...
			<p class="copyright" data-aos="zoom-in">© 2019 Aerosports. All Rights Reserved | Design by <a href="#" target="_blank">aerosports.com</a></p>
	</div>
	<!-- //footer -->
