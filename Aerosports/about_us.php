...
<body>
	...
	<div class="banner-bottom" id="about">
		<div class="container">
			<h3 class="heading-agileinfo" data-aos="zoom-in">Aerosports In Telangana</h3>
			<div class="w3ls_banner_bottom_grids">
				<div class="col-md-12 agileits_services_grid" data-aos="fade-right">
					<p class="text-color">
					Aero sports are a part of most adventure sports,which has gained popularity
					in Telangana. Aerosports hold a special appeal for those 
						who want to rise above the ordinary level. Air sports are 
						the best adventure sport which should try to experience the
						thrill in air and breathtaking views of the countryside. 
						As of now Aerosports are still in its infancy in Telangana.
						The basic techniques of hang gliding, launching, turning,
						landing. Telangana offers excellent locations for all types of flying
						sports such as paragliding, hang gliding and ballooning. Aerobatics and
						Gliding are not as much popular,compare to other flying recreational activities in Telangana.   
					</p>
				</div>
