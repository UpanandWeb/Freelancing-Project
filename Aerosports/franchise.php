...
<body>
	...
	<div class="banner-bottom" id="about">
		<div class="container">
			<h3 class="heading-agileinfo" ata-aos="zoom-in">EARN WHILE HAVING FUN</h3>
			<div class="w3ls_banner_bottom_grids">
				<div class="col-md-12 agileits_services_grid" data-aos="fade-right">
					<p>
					Aerosports Aviation is a result of pure passion and joy – the passion for and the joy of,
					flying. This place is the best spot of adventure trips and activities in Telangana and is 
					the hub for many adventure seekers, not to forget, the perfect place for execution of
					innovative advertising. This is where people can come forward and simply present a
					wonderful birthday gift for boyfriend, husband, girlfriend and moments of their anniversary.
					Aerosports is the place where magical minutes come to life. Aerosports is teaching people how to, Grow Your Wings. 
					</p>
				</div>
	...
	<section class="portfolio-agileinfo" id="gallery">
		<div class="container">
			<h3 class="heading-agileinfo" data-aos="zoom-in">BECOME A FRANCHISE<span>
            We are currently offering franchise for Telangana Districts:</span></h3>
				<div class="gallery-grids">
					<div class="tab_img">
						<div class="col-md-4 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
						<img src="aerosports gallery/Telangana.jpg" alt="tamilnadu state aerosports" style="width:100%;" />	 
						</div>
						<div class="col-md-8 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
						
							<form action="#" method="post" enctype="multipart/form-data" id="form-franchises">
							<div class="form col-md-10">						
							<div class="col-md-6">
							<input type="text" name="f_name" value="" placeholder="Your First Name" data-role="content"	>	</div><!--end col-md-4-->	
							<div class="col-md-6">
							<input type="text" name="f_email" value="" placeholder="Your last Name" data-role="content"	>	</div><!--end col-md-4-->							
							</div><!--end col-md-8-->
							<div class="clearfix"> </div>	
								<br>
							<div class="form col-md-10">	
							<div class="col-md-10">
							<input type="text" name="f_email" value="" placeholder="Your Email *" data-role="content"	>
							</div><!--end col-md-4-->							
							</div><!--end col-md-8-->
							<div class="clearfix"> </div>	
								<br>
							...
							<div class="form col-md-8">	
							<div class="col-md-8">
							<p><input type="submit" name="submit" value="Submit" id="franchise"></p>
							</div><!--end col-md-8-->	
							</div><!--end col-md-8-->
							</form>
		...
		<div class="w3ls_banner_bottom_grids">
				<div class="col-md-4 agileits_services_grid" data-aos="fade-right">
					...
					<div class="pr-ta text-color">
						...
						<p class="text-color-white">
							Aerial advertising is used to drop pamphlets covering a large amount of area. Due to which </p>						 
						<div class="tabl-erat">
							<div class="col-md-7 tag">
