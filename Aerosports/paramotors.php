...
<meta charset="utf-8">
<meta name = "keywords" content = "Paragliding, Paramotors, Flower Dropping, Aerial Advertising, Aerial Branding, Joy Rides" />
...
<body>
								...
								<li><a href="about_us.php" >About</a></li>
								 <li><a href="#" class="dropdown-toggle" data-toggle="dropdown" 
									...
									<ul class="dropdown-menu"> 
										<li class="active"><a href="paramotors.php">Paramotors</a></li>
	...
	<div class="banner-bottom" id="about">
		<div class="container">
			<h3 class="heading-agileinfo font-family" data-aos="zoom-in">Paramotors</h3>
			<div class="w3ls_banner_bottom_grids">
				<div class="col-md-12 agileits_services_grid" data-aos="fade-right">
               <div class="col-md-4">
                <img src="aerosports images/xsfly.jpg" alt="paragliding" class="custome_image" />
                </div><!--end col-md-4-->
				
					<div class="col-md-8">
                	<p class="text-color">
					One of the most unique way of gliding or flying is by using a paragliding wing  along with a propeller motor which is fixed on the harness. Para-motoring is used by the pilot to rise from the ground level without any assistance and gain altitude.
The unique thing about para-motor is that there is no need to launch from a high altitude place like a hill or mountain. Para-motors   today have speeds of up to 80km/h and are capable of flying for many hours.  Para-motors weight up to 30 kgs and are launched without wheels. They represent a easy and low budget option in the field of aviation.
